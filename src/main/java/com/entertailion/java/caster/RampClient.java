...
public class RampClient implements RampWebSocketListener {
  ...
  public RampClient(Playback playback, PlaybackListener playbackListener) {
    ...
    redirectStrategy = new TrackingRedirectStrategy();
    defaultHttpClient = HttpRequestHelper.createHttpClient(redirectStrategy);
      ...
      try {
        ...
        if (httpResponse != null) {
          ...
          if (responseCode == 204) {
            ...
            if (redirectStrategy.lastLocationUri != null) {
              lastUrl = redirectStrategy.lastLocationUri.toString();
  ...
  public void closeCurrentApp(DialServer dialServer) {
    if (dialServer != null) {
      try {
        TrackingRedirectStrategy redirectStrategy = new TrackingRedirectStrategy();
        HttpClient defaultHttpClient = HttpRequestHelper.createHttpClient(redirectStrategy);
  ...
  public String getCurrentApp(DialServer dialServer) {
    if (dialServer != null) {
      try {
        TrackingRedirectStrategy redirectStrategy = new TrackingRedirectStrategy();
        HttpClient httpClient = HttpRequestHelper.createHttpClient(redirectStrategy);
   ...
   */
  private int getAppStatus(HttpClient httpClient, String url) {
  ...
  /**
   * Custom HTTP redirection redirectStrategy to keep track of the redirected URL ChromeCast web server will redirect "/apps" to
   * "/apps/YouTube" if that is the active/last app
   */
  public class TrackingRedirectStrategy extends DefaultRedirectStrategy {

    public URI lastLocationUri;
    ...
    public URI getLocationURI(HttpRequest request, HttpResponse response, HttpContext context) throws ProtocolException {
      lastLocationUri = super.getLocationURI(request, response, context);
      return lastLocationUri;
    }
  }
