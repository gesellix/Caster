...
/**
 * A simple, tiny, nicely embeddable HTTP 1.0 server in Java Modified from NanoHTTPD, you can find it here
...
public class HttpServer {
  ...
  public static final String HTTP_OK = "200 OK", HTTP_PARTIALCONTENT = "206 Partial Content",
      HTTP_RANGE_NOT_SATISFIABLE = "416 Requested Range Not Satisfiable", HTTP_REDIRECT = "301 Moved Permanently", HTTP_FORBIDDEN = "403 Forbidden",
  ...
  private class HTTPSession implements Runnable {
     ...
     * Properties. NOTE: this doesn't support multiple identical keys due to the simplicity of Properties -- if you need
  ...
  static {
    StringTokenizer st = new StringTokenizer("css        text/css "
                                             + "js         text/javascript "
                                             + "jet         text/javascript "
                                             + // hack to avoid asset compression:
                                             ...
                                             + "avi        video/x-msvideo " + "m4u		video/vnd.mpegurl " + "m4v		video/x-m4v " + "mov		video/quicktime " + "mp4		video/mp4 "
                                             + "mpe		video/mpeg " + "mpeg		video/mpeg " + "mpg		video/mpeg " + "mxu		video/vnd.mpegurl " + "qt			video/quicktime " + "flv		video/x-flv "
                                             + "m3u8		application/x-mpegURL " + "ts			video/MP2T " + "3gp		video/3gpp " + "wmv		video/x-ms-wmv " + "pdf        application/pdf "
